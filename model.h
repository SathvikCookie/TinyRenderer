...
class Model {
    ...
    std::vector<vec3> norms = {}; // Vector to store the normals of each vertex in the point cloud
    ...
    public:
        ...
        vec3 normal(const int iface, int nthnorm) const; // Get the n'th norm of the i'th face of the object
};